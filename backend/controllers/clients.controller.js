...
export const createClient = async (req, res) => {
  try {
    ...
    const [result] = await pool.query(
      "INSERT INTO clients(trade_name, business_type, phone_or_cell, email, street, number_, neighborhood, postal_code, city, country, state_,  notes, contact_name, contact_title, contact_area_or_position, contact_cell_phone, contact_email) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
      [
        trade_name,
        business_type,
        phone_or_cell,
